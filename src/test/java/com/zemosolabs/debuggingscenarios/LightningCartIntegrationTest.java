...
public class LightningCartIntegrationTest {
  ...
  public void testSmoothCheckout(){
    ...
    //System.out.println(fCartService.getCart(CUSTOMER_1).keySet()+" " + item2.getQuantity());

//    for(Item s  : fCartService.getCart(CUSTOMER_1).keySet()){
//      System.out.println(s.getQuantity() * s.getCost());
//    }
